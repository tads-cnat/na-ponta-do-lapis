...
| Ações do ator | Ações do sistema |
| :-----------------: |:-----------------: | 
|  | 4.1 - O sistema verifica que alguma(s) informação(ões) não foi(foram) preenchida(s) corretamente e mostra uma mensagem de erro: "Alguma(s) informação(ões) não preenchida(s) ou inválida(s)!" e retorna o formulário com o(s) campo(s) inválido(s) pedindo o correto preenchimento |  
| | (retorna ao passo 3 do fluxo principal) |

## Fluxo Alternativo II - Visualizar conta
| Ações do ator | Ações do sistema |
| :-----------------: | :-----------------: | 
| 1.1 - O usuário seleciona a opção de "visualizar conta" | |  
...
| Ações do ator | Ações do sistema |
| :-----------: | :--------------: | 
| 1.2 - Na tela de listagem de contas, é selecionada a opção de "Alterar conta" | |  
...
| Ações do ator | Ações do sistema |
| :-----------: | :--------------: | 
| 1.3 - Na tela de listagem de contas, é selecionada a opção de "Excluir conta" | |  
| | 2.3 - O sistema solicita a confirmação do aluno |
| 3.4 - O usuário confirma a solicitação de exclusão | |
| | 4.2 - O sistema exclui a conta e apresenta uma mensagem de sucesso: "Conta 'x' excluída" |
