...
| Ações do ator | Ações do sistema |
| :-----------------: |:-----------------: |
| 3.1 - O administrador seleciona a opção "Editar" proximo ao post desejado | |
...
| Ações do ator | Ações do sistema |
| :-----------------: | :-----------------: |
| 3.2 - O administrador seleciona a opção "Excluir" proximo ao post desejado | |  
| | 4.2 - O sistema exibe um pop-up de confirmação de exclusão |
| 5.2 - O administrador seleciona o botão "Confirmar exclusão" | |
